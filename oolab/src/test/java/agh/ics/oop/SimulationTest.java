...
//        Assertions.assertEquals(animalsCount, actualAnimalsPlaced, "All animals should be placed if had different starting positions");
    ...
    void manyAnimalsLittleOrdersCase() {
        ...
        List<Vector2d> startingPositions = List.of(new Vector2d(2, 2), new Vector2d(3, 4), new Vector2d(6, 10), new Vector2d(1, 1), new Vector2d(1, 0), new Vector2d(15, 4), new Vector2d(3, 14), new Vector2d(6, 17), new Vector2d(2, 11), new Vector2d(16, 9), new Vector2d(14, 8), new Vector2d(7, 7), new Vector2d(11, 13));
        int animalsCount = startingPositions.size();
...
//        Assertions.assertEquals(animalsCount, actualAnimalsPlaced, "All animals should be placed if had different starting positions");
        ...
        Assertions.assertEquals(expectedAnimal5P, actualAnimal5P, "Animal should not move if after move it would enter on others animals field");
        Assertions.assertEquals(expectedAnimal5O, actualAnimal5O);


        for (int i = Orders.size(); i < animalsAfter.size(); i++) {
            Assertions.assertEquals(startingPositions.get(i), animalsAfter.get(i).getPosition(), "Position of unmoved animal " + i + " should remain the same");
            Assertions.assertEquals(MapDirection.NORTH, animalsAfter.get(i).getOrientation(), "Orientation of unmoved animal " + i + " should remain the same");
        }
        System.out.println(map);
    ...
    void manyAnimalsManyOrdersCase() {
        //given
        List<MoveDirection> Orders = OptionsParser.parse(new String[]{"f", "b", "r", "l", "f", "f", "r", "r", "f", "f", "f", "f", "f", "f", "f", "f", "f", "b", "f", "f", "l", "l", "r", "b", "b", "l", "b", "r", "r", "b", "f", "r", "b", "l", "b", "b", "b", "r", "b", "l", "b", "r", "r", "f", "l", "f", "f", "l", "b", "l", "b", "b", "f", "l", "b", "r", "l", "f", "f", "f", "f", "b", "r", "b", "f", "f"});
        List<Vector2d> startingPositions = List.of(new Vector2d(2, 2), new Vector2d(3, 4), new Vector2d(6, 10), new Vector2d(1, 1), new Vector2d(1, 0), new Vector2d(15, 4), new Vector2d(3, 14), new Vector2d(6, 17), new Vector2d(2, 11), new Vector2d(16, 9), new Vector2d(14, 8), new Vector2d(7, 7), new Vector2d(11, 13));
        int animalsCount = startingPositions.size();
        WorldMap map = new RectangularMap(19, 19);
        Simulation simulation = new Simulation(Orders, startingPositions, map);

        List<Vector2d> expectedPositions = List.of(new Vector2d(0, 3), new Vector2d(2, 3), new Vector2d(8, 10), new Vector2d(0, 1), new Vector2d(1, 0), new Vector2d(15, 7), new Vector2d(6, 14), new Vector2d(4, 17), new Vector2d(3, 11), new Vector2d(13, 10), new Vector2d(14, 9), new Vector2d(5, 8), new Vector2d(12, 14));
        List<MapDirection> expectedDirections = List.of(MapDirection.WEST, MapDirection.NORTH, MapDirection.WEST, MapDirection.EAST, MapDirection.WEST, MapDirection.NORTH, MapDirection.EAST, MapDirection.WEST, MapDirection.SOUTH, MapDirection.EAST, MapDirection.NORTH, MapDirection.EAST, MapDirection.WEST);
        ...
        for (int i = 0; i < expectedPositions.size(); i++) {
            ...
            Assertions.assertEquals(expectedPositions.get(i), current.getPosition(), "Animal " + i + " position is wrong");
            Assertions.assertEquals(expectedDirections.get(i), current.getOrientation(), "Animal " + i + " orientation is wrong");
        }
        System.out.println(map);
    }
}
...
class SimulationTest {
    ...
    void manyAnimalsLittleOrdersCase() {
        ...
        List<Vector2d> startingPositions = List.of(new Vector2d(2, 2), new Vector2d(3, 4), new Vector2d(6, 10), new Vector2d(1, 1), new Vector2d(1, 0), new Vector2d(15, 4), new Vector2d(3, 14), new Vector2d(6, 17), new Vector2d(2, 11), new Vector2d(16, 9), new Vector2d(14, 8), new Vector2d(7, 7), new Vector2d(11, 13));
        int animalsCount = startingPositions.size();
        WorldMap map = new FieldMap(19, 19);
        Simulation simulation = new Simulation(Orders, startingPositions, map);
